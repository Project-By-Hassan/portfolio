...
import certPythonCrashCourse from '../assets/certificate/python certificate.jpg';
...
import rightFixElectricalImage from '../assets/projects/website project.jpg';
        ...
        <div className="flex justify-between items-center">
          ...
          <div className="hidden sm:flex items-center gap-6">
            ...
            <div className="flex gap-6">
              ...
              <IconLink type="linkedin" href="https://www.linkedin.com/in/hassan-raza-awan/" />
...
function ThemeToggle() {
  ...
  return (
    <motion.button
      ...
      className="inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/5 px-4 py-2 text-sm font-semibold text-white/80 transition-colors hover:border-white/30 hover:text-white"
    >
      <svg className="h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
        <path d="M9 18h6" />
        <path d="M10 22h4" />
        <path d="M8.5 14.5C7.55 13.65 7 12.43 7 11a5 5 0 0 1 10 0c0 1.43-.55 2.65-1.5 3.5-.65.58-1 1.15-1.15 1.8h-4.7c-.15-.65-.5-1.22-1.15-1.8Z" />
        <path d="M12 2V1" />
      ...
      <span>{isLight ? 'Light' : 'Dark'} theme</span>
    </motion.button>
  );
}
...
function ProjectsSection() {
  const projects = [
    {
      id: 0,
      title: 'RightFix Electrical',
      period: 'Website Development',
      description: 'A professional business website developed for RightFix Electrical to present its electrical services with a clear, trustworthy, and responsive online experience.',
      image: rightFixElectricalImage,
      liveLink: 'https://rightfixelectrical.co.uk',
      tags: ['Website Development', 'Responsive Design', 'Business Website']
    },
    {
      id: 1,
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <div className="relative flex flex-col md:flex-row md:items-end md:justify-between gap-6">
            ...
            <motion.a
              href="/hassan%20raza%27s%20resume.pdf"
...
export default function App() {
  return (
    <div className="bg-[#1f1f1f] min-h-screen text-white overflow-x-hidden transition-colors duration-500">
      <ScrollProgressBar />
      <Navigation />
      <main>
        <HeroSection />
